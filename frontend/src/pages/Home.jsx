            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-center">
              ...
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center gap-3 px-8 py-4 rounded-full border border-white/20 bg-white/10 backdrop-blur-sm text-white font-bold text-xs tracking-[0.2em] uppercase hover:bg-[#25D366] hover:border-[#25D366] transition-all duration-500"
                >
